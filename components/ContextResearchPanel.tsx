...
export function ContextResearchPanel({
  ...
  const copyToClipboard = (text: string, type: 'hook' | 'linkedin' = 'hook') => {
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-start justify-center overflow-y-auto py-8">
      <div className="bg-white dark:bg-slate-950 rounded-lg shadow-xl w-full max-w-3xl mx-4 my-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* LinkedIn Message */}
          {research.messaging_brief.linkedin_message && (
            <div className="rounded-lg border border-blue-200 dark:border-blue-800 overflow-hidden">
              <div className="px-4 py-3 bg-blue-50 dark:bg-blue-900/30 border-b border-blue-200 dark:border-blue-800 flex items-center justify-between">
                ...
                <button
                  onClick={() =>
                    copyToClipboard(research.messaging_brief.linkedin_message!, 'linkedin')
                  }
                  className="px-2 py-1 text-xs font-medium text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-white border border-blue-200 dark:border-blue-700 rounded hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors"
                >
