...
export function Dashboard() {
  ...
  const getModeClass = (buttonMode: string) => {
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex rounded-md border border-slate-200">
                <button
                  ...
                  className={getModeClass("manual") + " rounded-l-md"}
                >
                  Manual
                </button>
                <button
                  onClick={() => handleModeChange("auto")}
                  className={getModeClass("auto") + " rounded-r-md"}
                >
                  Auto
                </button>
              </div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-colors">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-slate-600">{getStatusText(campaign.status)}</span>
                        </div>
                        {campaign.status === "completed" && (
                          <Badge variant="secondary">{campaign.total_contacts} contacts</Badge>
                        )}
                      </div>
                    </div>
                  </Link>
